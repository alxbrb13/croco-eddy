...
% MODIF abarboni for matlab on Datarmor :
%   - InPolygon in Polyfun toolbox replaced by inpolygon directly added to path
%   - source = 'WindEddy'
% Addding sources to path ?
%addpath('/home6/datahome/abarboni/AMEDA/sources/')
%addpath('/home6/datahome/abarboni/AMEDA/tools/')
addpath('/appli/matlab/2018b/toolbox/matlab/polyfun/')

% Changing folder
%cd('/home6/datahome/abarboni/AMEDA/')
% end modif abarboni
...
%----------------------------------------
% Free workers
% delete(gcp('nocreate'))  %%% Modif Abarboni, no parpool
