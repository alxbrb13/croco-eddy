...
#if defined IN_REAL_WIND || defined IN_REAL_STFLUX || defined BULK_LMD
      integer , parameter :: nmax = 20000
      real,dimension(nmax) :: time_in,u10_in, v10_in, flux_in, shw_in
# if defined BULK_SPATIAL
      real,dimension(nmax) :: u10_std, v10_std, shw_std, lw_std
# endif
      real,dimension(nmax) :: pmer_in,prate_in,lw_in,sst_in,at_in,rhum_in
      integer :: kount
      common /flux_arp/time_in,u10_in, v10_in,shw_in, pmer_in,prate_in
      common /flux_arp/lw_in,sst_in,at_in,rhum_in, kount
#endif
