...
!      parameter (LLm0=90,  MMm0=90,  N=30)    ! 20 km resolution
!      parameter (LLm0=60,   MMm0=60,   N=10)  ! 30 km resolution
!       parameter (LLm0=100, MMm0=100, N=30)   ! 10 km resolution
!       parameter (LLm0=120, MMm0=120, N=50)   ! 5 km resolution
!       parameter (LLm0=100, MMm0=100, N=30)    ! 5km resolution Xmax=250km Hmax=1500m
!       parameter (LLm0=300, MMm0=300, N=100)   ! 2 km resolution Xmax=300km Hmax=3000m
!       parameter (LLm0=250, MMm0=250, N=75)   ! 2km resolution Xmax = 250km Hmax=1500m
...
!
      ...
      parameter (NP_XI=10,  NP_ETA=10,  NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
