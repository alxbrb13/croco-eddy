...
#define  VORTEX_LMD          /* Baroclinic Vortex Example */
...
#elif defined VORTEX_LMD
/*
!                       Baroclinic Vortex for LMD work, A. Barboni  added Nov 2020
!                       ========== ====== ======= ===== ======
*/
# undef  OPENMP
# define  MPI
...
/* Tracer - Salinity */
# undef SALINITY    /*To change for salinity*/

/* Fluxes */
# undef IN_STFLUX /* temperature flux */
# undef IN_SSFLUX /* Salinity flux */
# undef IN_WIND /* wind shear */
# undef IN_WIND_CFB /*wind with current feedback*/
# undef IN_REAL_WIND    /* Get real ARPEGE flux - excludes IN_WIND */
# undef IN_REAL_STFLUX   /* Get real ARPEGE flux - excludes IN_STFLUX */
# undef IN_REAL_SRFLUX  /* get real ARPEGE short wave flux    */
# undef ANA_STFLUX
# undef ANA_SSFLUX /*To change for salinity*/
# undef ANA_SMFLUX
# define ANA_BSFLUX
# define ANA_BTFLUX
# define AVERAGES
...
# ifdef BULK_FLUX
#  undef SFLUX_CFB
#  undef CFB_WIND_TRA /* New abarboni >> Turbulent Flux Current Feedback */
#  undef CFB_STRESS  /* New abarboni for current feedback */
#  undef  BULK_ECUMEV0
#  undef  BULK_ECUMEV6
#  undef  BULK_WASP
#  define BULK_GUSTINESS
...
/*Melange vertical*/
# undef ANA_VMIX 
# define GLS_MIXING /*New*/
# define ANA_SRFLUX /*New - with GLS*/
# define TEST_AB_GLS

/* Viscosité horizontale */
# define UV_VIS2 /*DIFF*/
# define TS_DIF2 /*DIFF*/
/* define UV_VIS_SMAGO New*/
/*# define TS_DIF_SMAGO  TEST New*/
...
# undef OBC_SOUTH  /*New*/
# undef SPONGE     /*New*/
# define EW_PERIODIC /*New*/
# define NS_PERIODIC /*New*/

/*Climatology*/
# undef ZCLIMATOLOGY /* Changed */
# undef M2CLIMATOLOGY /* Changed */
# undef M3CLIMATOLOGY /* Changed */
# undef TCLIMATOLOGY /* Changed */
# undef ZNUDGING     /* Changed */
# undef M2NUDGING    /* Changed */
# undef M3NUDGING /* Changed */
# undef TNUDGING  /* Changed */
# define NO_FRCFILE /* Keep it defined if no climatology*/ 
# undef  RVTK_DEBUG  
